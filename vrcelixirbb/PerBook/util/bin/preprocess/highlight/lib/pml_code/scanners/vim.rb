...
module Scanners
  ...
  class Vim < Scanner
    ...
    KEYWORDS =  %w{
          abc abclear argdo argu argument bel belowright
        ...
        OPTIONS = %w{
          acd ambiwidth arabicshape autowriteall backupdir bdlay binary
        ...
        OTHER = %w{
          ...
          au autocmd do doautocmd doautoa doautoall

          map cm cmap cno cnoremap im imap ino
          inoremap ln lnoremap nm nmap nn nnoremap no noremap
          om omap ono onoremap snor snoremap vm vmap vn vnoremap xn xnoremap

          BufRead ModeMsg None BufAdd BufCreate BufDelete
