...
module Scanners
  ...
  class Dart < Scanner
    ...
    KEYWORDS = %w[
       break case catch class const continue default do else extends final 
       finally for if in is new return super switch this throw try var void while
    ]
    ...
    RESERVED_WORDS = %w[
       abstract assert Dynamic factory  get implements import interface library negate operator set
