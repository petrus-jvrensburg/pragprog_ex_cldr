  ...
  module Scanners
    ...
    class Clojure < Scanner
      ...
      CORE_FORMS = %w[
        ...
        filter find find-doc find-ns find-var first flatten float float-array float?
        floats flush fn fn? fnext for force format frequencies
        future future-call future-cancel
        ...
        partition partition-by pcalls peek persistent! pmap pop pop! pop-thread-bindings
        ...
        re-matches re-pattern re-seq read read-line read-string reduce reductions ref
