...
def drawImage(node, output):
    ...
    # startElement(output,
    #              "dave", SVGMathNS, "svgmath:",
    #              { u"node-height": node.height,
    #                u"node-ascender": node.ascender,
    #                u"node-depth":    node.depth,
    #                u"node-descender": node.descender,
    #                u"baseline": baseline
    #              } )
