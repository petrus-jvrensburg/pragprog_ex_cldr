...
ENVS = {
  ...
  "mathit" => lambda { |x| markup "<mi>#{x}</mi>", "mstyle", 'fontstyle="italic"' },
  "mathrm" => lambda { |x| markup "<mi>#{x}</mi>", "mstyle", 'fontstyle="normal" fontweight="normal"' },
  "mathbf" => lambda { |x| markup "<mi>#{x}</mi>", "mstyle", 'fontweight="bold"' },
